...
<?php 
	...
	$resultado1 = $estadistica1->get_lecturasPorPeriodoUsuario($_SESSION['ClienteId'], $periodo, $idusuario);
	
	while ($fila1 = $resultado1->fetch_assoc()) 
	{    
		$lperiodos .=  "\"" . $fila1['nrdia'] . "\",";
		$vperiodos .= 	"\"" . $fila1['LecturasTotales'] . "\",";
	}
...
<div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Evolución de Lecturas</h3>
